...
var greenBright = require('chalk').greenBright;
...
var initialize = function () {
    ...
    if (needsToSave) {
        saveMetadata().then(() => { return console.log('Written initial metadata.json file'); });
    }
    Git.Repository.open(dir + "/.git").then(() => { return console.log(greenBright('Found posts git repository')); }, () => {
        var repo, index;
...
var saveMetadata = function () { return __awaiter(void 0, void 0, void 0, function () {
...
var getPostBody = function (postId) { return __awaiter(void 0, void 0, void 0, function () {
...
var setPostBody = function (postId, newBody) { return __awaiter(void 0, void 0, void 0, function () {
    var beautified;
    return __generator(this, (_a) => {
        switch (_a.label) {
            case 0:
                ...
                return [4, writeFile(dir + "/" + postId + ".json", beautified, { encoding: 'utf8' }, (err) => {
                        if (err) {
                            console.log(err);
                        }
                        else {
...
var createPost = function (author, title, description, tags, body) { return __awaiter(void 0, void 0, void 0, function () {
    var postId, metadata;
    return __generator(this, (_a) => {
        switch (_a.label) {
            case 0:
                postId = nextPostId++;
                return [4, setPostBody(postId, body)];
            case 1:
                _a.sent();
                ...
                return [4, saveMetadata()];
            case 2:
                _a.sent();
                return [4, commit(postId, "Create " + title, author)];
            case 3:
                _a.sent();
                return [2, metadata];
        }
...
var getNetworkPostObject = function (postId) { return __awaiter(void 0, void 0, void 0, function () {
    var metadata;
    var _a;
    return __generator(this, (_b) => {
        switch (_b.label) {
            case 0:
                metadata = getMetadata(postId);
                _a = {
                    id: postId,
